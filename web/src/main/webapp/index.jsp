...
<nav class="navbar navbar-inverse navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${pageContext.request.contextPath}/">PA165 Sport Event Manager</a>
        </div>
...
<div class="container">
    ...
    <div ng-app="pa165semApp"><!-- AngularJS takes care of this element -->
